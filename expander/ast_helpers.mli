...
val generate_encoding :
  Ppxlib.core_type -> string option -> Ppxlib.expression
val take_a :
...
val objN_enc_from_ldl :
  ...
  Ppxlib.label_declaration Base.List.t -> string option -> Ppxlib__.Import.expression
val make_obj_n :
  loc:Ppxlib__.Import.location ->
  Ppxlib.label_declaration Base.List.t -> string option -> Ppxlib__.Import.expression
...
val single_field_record :
  loc:Ppxlib__.Import.location ->
  Ppxlib.label_declaration -> string option ->  Ppxlib.expression
val mult_field_record :
  loc:Ppxlib__.Import.location ->
  Ppxlib.label_declaration Base.List.t -> string option -> Ppxlib.expression
val single_case_variant :
  loc:Ppxlib__.Import.location ->
  Ppxlib.constructor_declaration -> string option -> Ppxlib.expression
val generate_cases :
  loc:Ppxlib__.Import.location ->
  Ppxlib.constructor_declaration list -> string option -> Ppxlib.expression