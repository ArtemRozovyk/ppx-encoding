...
let encoding_of_par_rec_type1 =
  let open! Data_encoding in
    fun _a_encoding ->
      fun _b_encoding ->
        mu "par_rec_type1"
          (fun par_rec_type1_encoding ->
             union ~tag_size:`Uint8
               [case ~title:"Ie" (Tag 0) (obj1 (req "Ie" _a_encoding))
                  (function | Ie ie -> Some ie | _ -> None) (fun ie -> Ie ie);
               case ~title:"Ne" (Tag 1)
               ...
               case ~title:"Ker" (Tag 2)
                 ...
                 (function
                  | Ker (ker0, ker1) -> Some (ker0, ker1)
                  | _ -> None) (fun (ker0, ker1) -> Ker (ker0, ker1))])
        ...
        (fun rec_t2_encoding ->
           union ~tag_size:`Uint8
             ...
             case ~title:"V" (Tag 5)
               (obj1
                  (req "V"
                     (obj2 (req "nunu" rec_t2_encoding)
                        (req "nini" _a_encoding))))
